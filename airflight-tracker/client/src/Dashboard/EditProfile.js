...
const EditProfile = () => {
  ...
  const trainingCompletedOptions = [
    ...
    "C-130 Hercules Initial Qualification Course",
    "Boeing 767 Type Rating",
    "KC-135 Stratotanker Type Rating",
    "Aerial Refueling Course",
    "Combat Airlift Course",
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/api/user/profile/${localStorage.getItem(
          "userId"
        )}/upload`,
        {
          method: "POST",
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <input
              ...
              value={nvgHours}
              min="0"
              onChange={(e) => setNvgHours(e.target.value)}
            />
          </label>
          <label>
            Profile Image:
          ...
          <label>
            ...
            <div className={`dropdown ${dropdowns.aircraft ? "active" : ""}`}>
              <div
                ...
                onClick={() => toggleDropdown("aircraft")}
              >
                Select Aircraft Qualification{" "}
                <span
                  className={`arrow ${dropdowns.aircraft ? "up" : "down"}`}
                ></span>
              </div>
          ...
          <label>
            ...
            <div className={`dropdown ${dropdowns.training ? "active" : ""}`}>
              ...
              >
                Select Training Completed{" "}
                <span
                  className={`arrow ${dropdowns.training ? "up" : "down"}`}
                ></span>
              </div>
              <div className="dropdown-options">
          ...
          <label>
            ...
            <div className={`dropdown ${dropdowns.language ? "active" : ""}`}>
              ...
              >
                ...
                <span
                  className={`arrow ${dropdowns.language ? "up" : "down"}`}
                ></span>
              </div>
              <div className="dropdown-options">
